...
\newcommand{\discordurl}{https://discord.com/channels/1463307373580914803}
...
\newcommand{\numcredits}{3}
\newcommand{\lectimeandloc}{Mon and Wed 5:30 -- 6:45PM / KY 258}
\newcommand{\requiredlabtimeandloc}{}
\newcommand{\tataofficehourtimeandloc}{(none)}
\newcommand{\numtheoryhws}{3}
...
Examining the below two flowcharts, we note that MATH 341 and 343 form a series of two statistics courses: the first, theoretical with traditional topics and the second, computational with modern topics. Both heavily rely on the theoretical topics taught in MATH 340.
...
Labs are the \qu{practice} part of the homework assignment. They will complement the theory homework and are due on the same day also by pushing it to your github repository.
